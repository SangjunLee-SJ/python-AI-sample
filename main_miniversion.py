...
class ISICDataset(Dataset):
    def __init__(self, data_dir, metadata_path, transform=None, load_percent=0.1):
        ...
        # Only load a certain percentage of the data
        num_samples = int(len(file_names) * load_percent)
...
dataset = ISICDataset(data_dir, metadata_path, transform=preprocess, load_percent=0.1)
